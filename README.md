...
- 🔍 Умный поиск групп по части названия
- 🎯 Упрощённый выбор группы (без разделения по /)
- 📱 Reply-клавиатура для удобной навигации
- 📌 Система дежурств с автоматической ротацией
- 🤒 Отметки о болезни студентов
- 🔐 PIN-коды для групп (устанавливаются старостами)
- ❓ Улучшенная справка и подсказки
...
- 🎯 Умный поиск групп с нормализацией названий
...
| `/change_group [группа]` | Сменить группу без перерегистрации |
...
После регистрации доступно удобное меню с быстрыми действиями:
- 📅 Сегодня — показать расписание на сегодня
- 📆 Завтра — показать расписание на завтра
- 🗓 Неделя — показать расписание на неделю
- 🔍 Поиск группы — найти и выбрать группу
- ⚙️ Сменить группу — изменить текущую группу
